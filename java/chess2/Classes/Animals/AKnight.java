...
public class AKnight implements PieceInf
{
	...
	public AKnight(char team, char moveSet, char contents, boolean hasMoved, int tier)
	{
		this.team = team;
						...
						for (int b = -1; b < 2; b = b + 2) {
							if ((row + a) >= 0 && (row + a) <= 7 && (col + b) >= 0
								...
								if (
                                                ...
                                                &&
                                                (theGame.getTheGame()[row+a][col+b].getContents().getTeam() != 'w' || theGame.getTheGame()[row+a][col+b].getContents().getContents() != 'x')) {
							...
							if ((row + b) >= 0 && (row + b) <= 7 && (col + a) >= 0
								...
								if (
                                                ...
                                                &&
                                                (theGame.getTheGame()[row+b][col+a].getContents().getTeam() != 'w' || theGame.getTheGame()[row+b][col+a].getContents().getContents() != 'x')) {
						...
						for (int b = -1; b < 2; b = b + 2) {
							if ((row + a) >= 0 && (row + a) <= 7 && (col + b) >= 0
								...
								if (
												...
												(theGame.getTheGame()[row + a][col + b].getContents().getMoveSet() != 'N' || theGame.getTheGame()[row + a][col + b].getContents().getContents() != 'q')
                                                &&
                                                (theGame.getTheGame()[row+a][col+b].getContents().getTeam() != 'b' || theGame.getTheGame()[row+a][col+b].getContents().getContents() != 'x')) {
									(theGame.getTheGame())[row + a][col + b]
											.setHighlight(true);
									(theGame.getTheGame())[row + a][col + b]
											.setNeedsRedraw(true);
							...
							if ((row + b) >= 0 && (row + b) <= 7 && (col + a) >= 0
								...
								if (				
												...
												(theGame.getTheGame()[row + b][col + a].getContents().getMoveSet() != 'N' || theGame.getTheGame()[row + b][col + a].getContents().getContents() != 'q')
                                                &&
                                                (theGame.getTheGame()[row+b][col+a].getContents().getTeam() != 'b' || theGame.getTheGame()[row+b][col+a].getContents().getContents() != 'x')) {
									(theGame.getTheGame())[row + b][col + a]
											.setHighlight(true);
									(theGame.getTheGame())[row + b][col + a]
											.setNeedsRedraw(true);
