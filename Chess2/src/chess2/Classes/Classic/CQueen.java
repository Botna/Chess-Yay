...
public class CQueen implements PieceInf
{
	...
	public CQueen(char team, char moveSet, char contents, boolean hasMoved)
	{
		this.team = team;
				...
				if ((row + a) >= 0 && (row + a) <= 7 && (col + a) >= 0
					...
					if (((theGame.getTheGame())[row + a][col + a]
						...
						if (theGame.getTheGame()[row + a][col + a]
								...
								(theGame.getTheGame()[row+a][col+a].getContents().getMoveSet() != '2' || theGame.getTheGame()[row+a][col+a].getContents().getContents() != 'r') && //

								(theGame.getTheGame()[row][col].getContents().getMoveSet() != '3' || theGame.getTheGame()[row+a][col+a].getContents().getContents() == 'x')) {
							(theGame.getTheGame())[row + a][col + a]
									.setHighlight(true);
							(theGame.getTheGame())[row + a][col + a]
									.setNeedsRedraw(true);
				...
				if ((row + a) >= 0 && (row + a) <= 7) {
					if (((theGame.getTheGame())[row + a][col].getContents())
						...
						if (((theGame.getTheGame())[row + a][col]
								...
								(theGame.getTheGame()[row+a][col].getContents().getMoveSet() != '2' || theGame.getTheGame()[row+a][col].getContents().getContents() != 'r') && 

								(theGame.getTheGame()[row][col].getContents().getMoveSet() != '3' || theGame.getTheGame()[row+a][col].getContents().getContents() == 'x')) {
							(theGame.getTheGame())[row + a][col]
									.setHighlight(true);
							(theGame.getTheGame())[row + a][col]
									.setNeedsRedraw(true);
				...
				if ((col + a) >= 0 && (col + a) <= 7) {
					if (((theGame.getTheGame())[row][col + a].getContents())
						...
						if (((theGame.getTheGame())[row][col + a]
								...
								(theGame.getTheGame()[row][col+a].getContents().getMoveSet() != '2' || theGame.getTheGame()[row][col+a].getContents().getContents() != 'r') && 

								(theGame.getTheGame()[row][col].getContents().getMoveSet() != '3' || theGame.getTheGame()[row][col+a].getContents().getContents() == 'x')) {
							(theGame.getTheGame())[row][col + a]
									.setHighlight(true);
							(theGame.getTheGame())[row][col + a]
									.setNeedsRedraw(true);
