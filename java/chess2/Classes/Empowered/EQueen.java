...
public class EQueen implements PieceInf
{
	...
	public EQueen(char team, char moveSet, char contents, boolean hasMoved, int tier)
	{
		this.team = team;
	...
	if ((row + 1) >= 0 && (row + 1) <= 7) {
		if (((theGame.getTheGame())[row + 1][col].getContents())
			...
			if (((theGame.getTheGame())[row + 1][col].getContents())
					.getTeam() == 'b'
					&& 				
					(theGame.getTheGame()[row+1][col].getContents().getMoveSet() != 'R' || theGame.getTheGame()[row+1][col].getContents().getContents() != 'r')
					&&
					(theGame.getTheGame()[row+1][col].getContents().getMoveSet() != 'N' || theGame.getTheGame()[row+1][col].getContents().getContents() != 'q')
					) {
				(theGame.getTheGame())[row + 1][col]
						.setHighlight(true);
				(theGame.getTheGame())[row + 1][col]
	...
	if ((col + 1) >= 0 && (col + 1) <= 7) {
		if (((theGame.getTheGame())[row][col + 1].getContents())
			...
			if (((theGame.getTheGame())[row][col + 1].getContents())
					.getTeam() == 'b'
					&& 				
					(theGame.getTheGame()[row][col+1].getContents().getMoveSet() != 'R' || theGame.getTheGame()[row][col+1].getContents().getContents() != 'r')
					&&
					(theGame.getTheGame()[row][col+1].getContents().getMoveSet() != 'N' || theGame.getTheGame()[row][col+1].getContents().getContents() != 'q')
					) {
				(theGame.getTheGame())[row][col + 1]
						.setHighlight(true);
				(theGame.getTheGame())[row][col + 1]
