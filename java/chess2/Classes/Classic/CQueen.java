...
public class CQueen implements PieceInf
{
	...
	public CQueen(char team, char moveSet, char contents, boolean hasMoved, int tier)
	{
		this.team = team;
				...
				if ((row + a) >= 0 && (row + a) <= 7 && (col + a) >= 0
					...
					if (((theGame.getTheGame())[row + a][col + a]
						...
						if (theGame.getTheGame()[row + a][col + a]
								...
								(theGame.getTheGame()[row][col].getContents().getMoveSet() != 'N' || theGame.getTheGame()[row+a][col+a].getContents().getContents() == 'q')) {

                            if(theGame.getTheGame()[row+a][col+a].getContents().getMoveSet() == 'A' && theGame.getTheGame()[row+a][col+a].getContents().getContents() == 'r')
                            {
				...
				if ((row + a) >= 0 && (row + a) <= 7) {
					if (((theGame.getTheGame())[row + a][col].getContents())
						...
						if (((theGame.getTheGame())[row + a][col]
								...
								(theGame.getTheGame()[row][col].getContents().getMoveSet() != 'N' || theGame.getTheGame()[row+a][col].getContents().getContents() == 'q')) {
				...
				if ((col + a) >= 0 && (col + a) <= 7) {
					if (((theGame.getTheGame())[row][col + a].getContents())
						...
						if (((theGame.getTheGame())[row][col + a]
								...
								(theGame.getTheGame()[row][col].getContents().getMoveSet() != 'N' || theGame.getTheGame()[row][col+a].getContents().getContents() == 'q')) {
